...
(Q.prototype.e = function (e) {
  ...
  (G.prototype.D = function (e) {
    for (
      var t = window.atob(e),
        n = (t.charCodeAt(0) << 8) | t.charCodeAt(1),
        r = [],
        i = 2;
      i < n + 2;
      i += 2
  ...
  (G.prototype.v = function (e, t, n) {
    for (
      t = t || 0,
        n = n || [],
        this.C = t,
        "string" === typeof e ? this.D(e) : ((this.G = e), (this.b = n)),
        this.o = !0,
        this.R = Date.now();
      this.o;
...
function keys() {
  const api = `/remix/well/1431705106886184960/catalog?offset=10&limit=13&order_by=global_idx&is_new_column=true`;
  return `101_3_2.0+${api}+AEBXshZlHRaPTsBrhraibR2XUmQ62Op7oTg=|1672709778`;
}

console.log(b(md5(keys())))
module.exports = b;
